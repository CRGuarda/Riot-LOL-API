export const itemsJSON = {
  ...
  data: {
    ...
    '1026': {
      ...
      into: ['3115', '3116', '6655', '3135', '3152', '4633', '4637', '6657'],
      image: {
        full: '1026.png',
        sprite: 'item0.png',
        group: 'item',
    ...
    '1038': {
      ...
      into: ['3026', '3031', '3072', '3161', '4403', '6671'],
      image: {
        full: '1038.png',
        sprite: 'item0.png',
        group: 'item',
    ...
    '1042': {
      ...
      into: ['1043', '6677', '3086', '3006', '3051', '6670'],
      image: {
        full: '1042.png',
        sprite: 'item0.png',
        group: 'item',
    ...
    '3023': {
      ...
      tags: ['Health', 'Armor', 'AbilityHaste'],
      maps: {
        '11': true,
        '12': true,
        '21': true,
    ...
    '3094': {
      ...
      tags: ['Damage', 'CriticalStrike', 'NonbootsMovement'],
      maps: {
        '11': true,
        '12': true,
        '21': true,
    ...
    '3161': {
      ...
      tags: ['Health', 'Damage', 'NonbootsMovement', 'AbilityHaste'],
      maps: {
        '11': true,
        '12': true,
        '21': true,
    ...
    '3181': {
      ...
      tags: ['Health', 'SpellBlock', 'Armor', 'Damage', 'NonbootsMovement'],
      maps: {
        '11': true,
        '12': false,
        '21': true,
    ...
    '3222': {
      ...
      tags: ['SpellBlock', 'ManaRegen', 'Active', 'Tenacity'],
      maps: {
        '11': true,
        '12': true,
        '21': true,
    ...
    '6616': {
      ...
      tags: ['SpellDamage', 'ManaRegen', 'NonbootsMovement'],
      maps: {
        '11': true,
        '12': true,
        '21': true,
    ...
    '6620': {
      ...
      tags: ['Health', 'SpellDamage', 'ManaRegen', 'CooldownReduction'],
      maps: {
        '11': true,
        '12': true,
        '21': true,
    ...
    '6671': {
      name: 'Galeforce',
      description:
        "<mainText><stats><attention>55</attention> Attack Damage<br><attention>15%</attention> Attack Speed<br><attention>20%</attention> Critical Strike Chance<br><attention>7%</attention> Move Speed</stats><br><br><active>Active -</active> <active>Cloudburst:</active> Dash in target direction, firing three missiles at the lowest Health enemy near your destination. Deals physical damage, increased against low Health targets.<br><br><rarityMythic>Mythic Passive:</rarityMythic> Grants all other <rarityLegendary>Legendary</rarityLegendary> items <attention>5</attention> Attack Damage.<br><br><rules>Maximum missile damage dealt when enemy Health is below 25%.<br>Cloudburst's dash cannot pass through terrain.</rules></mainText><br>",
      colloq: '',
      plaintext: '',
      from: ['1038', '3086', '1036'],
      into: ['7006'],
      ...
      tags: ['Damage', 'CriticalStrike', 'Active', 'NonbootsMovement'],
      maps: {
        '11': true,
        '12': true,
        '21': true,
    ...
    '6673': {
      ...
      description:
        '<mainText><stats><attention>50</attention> Attack Damage<br><attention>20%</attention> Critical Strike Chance<br><attention>7%</attention> Life Steal</stats><br><li><passive>Lifeline:</passive> When taking damage that would reduce you below 30% Health, gain a Shield. In addition, gain Attack Speed.</mainText><br>',
      colloq: '',
      plaintext: '',
      from: ['1037', '1018', '1053'],
      into: ['7008'],
    ...
    '7006': {
      name: 'Typhoon',
      description:
        "<mainText><stats><ornnBonus>70</ornnBonus> Attack Damage<br><ornnBonus>30%</ornnBonus> Attack Speed<br><attention>20%</attention> Critical Strike Chance<br><ornnBonus>10%</ornnBonus> Move Speed</stats><br><br><active>Active -</active> <active>Cloudburst:</active> Dash in target direction, firing three missiles at the lowest Health enemy near your destination. Deals physical damage, increased against low Health targets.<br><br><rarityMythic>Mythic Passive:</rarityMythic> Grants all other <rarityLegendary>Legendary</rarityLegendary> items <attention>5</attention> Attack Damage.<br><br><rules>Maximum missile damage dealt when enemy Health is below 25%.<br>Cloudburst's dash cannot pass through terrain.</rules></mainText><br>",
      colloq: '',
      plaintext: '',
      from: ['6671'],
      inStore: false,
    ...
    '7007': {
      ...
      description:
        '<mainText><stats><ornnBonus>85</ornnBonus> Attack Damage<br><ornnBonus>40%</ornnBonus> Attack Speed<br><attention>20%</attention> Critical Strike Chance</stats><br><li><passive>Bring It Down:</passive> Every third Attack deals additional magic damage. Repeated triggers on the same target increase the damage dealt.</mainText><br>',
      colloq: '',
      plaintext: '',
      from: ['6672'],
      inStore: false,
    ...
    '7008': {
      name: 'Bloodward',
      description:
        '<mainText><stats><ornnBonus>60</ornnBonus> Attack Damage<br><ornnBonus>0%</ornnBonus> Attack Speed<br><attention>8%</attention> Life Steal</stats><br><li><passive>Lifeline:</passive> When taking damage that would reduce you below 30% Health, gain a Shield. In addition, gain Attack Speed.</mainText><br>',
      colloq: '',
      plaintext: '',
      from: ['6673'],
      inStore: false,
    ...
    '7019': {
      ...
      tags: ['Health', 'SpellBlock', 'HealthRegen', 'Armor', 'Aura', 'Active'],
      maps: {
        '11': true,
        '12': true,
        '21': true,
    ...
    '7029': {
      name: "Youmuu's Wake",
      description:
        '<mainText><stats><ornnBonus>75</ornnBonus> Attack Damage<br><ornnBonus>26</ornnBonus> Lethality<br><ornnBonus>25</ornnBonus> Ability Haste</stats><br><br><active>Active -</active> <active>Wraith Step:</active> Gain Move Speed and Ghosting.<br><li><passive>Haunt:</passive> Gain up to 100 Spectral Shards while moving. Gain up to <speed> Move Speed</speed> out of champion combat based on the number of Spectral Shards. While at max shards, gain <scaleAD> Lethality</scaleAD>. Shards will reset 3 seconds after dealing damage to an enemy champion.<br><br><rarityMythic>Mythic Passive:</rarityMythic> Grants all other <rarityLegendary>Legendary</rarityLegendary> items <attention></attention> Attack Damage. <br><br><rules><status>Ghosted</status> units ignore collision with other units.</rules></mainText><br>',
      colloq: '',
      plaintext: '',
      from: ['3142'],
      inStore: false,
    ...
    '7032': {
      name: 'Flicker',
      description:
        '<mainText><stats><ornnBonus>80</ornnBonus> Attack Damage<br><attention>20%</attention> Critical Strike Chance<br><ornnBonus>30</ornnBonus> Ability Haste</stats><br><li><passive>Transcendence:</passive>  Your Attacks reduce your non-Ultimate Ability cooldowns.<li><passive>Impermanence:</passive> Your abilities deal increased damage based on Critical Strike Chance.<br><br><rarityMythic>Mythic Passive:</rarityMythic> Grants all other <rarityLegendary>Legendary</rarityLegendary> items <attention>5</attention> Ability Haste.</mainText><br>',
      colloq: '',
      plaintext: '',
      from: ['6675'],
      inStore: false,
